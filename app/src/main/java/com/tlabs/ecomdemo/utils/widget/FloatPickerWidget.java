package com.tlabs.ecomdemo.utils.widget;
 ...
 */
public class FloatPickerWidget extends RelativeLayout implements TextWatcher {
    ...
    public FloatPickerWidget(Context context, AttributeSet attributeSet) {
        ...
        if (subtractButtonLabel == null) {
            subtractButtonLabel = DEFAULT_SUBTRACT_BUTTON_LABEL;
        }
    ...
    private void create(Context context, AttributeSet attributeSet) {
        ...
        buttonAdd.setBackground(getResources().getDrawable(R.drawable.btn_add));
        addView(buttonAdd, lp);

        lp = new LayoutParams(getResources().getDimensionPixelOffset(R.dimen.dimen_36), getResources().getDimensionPixelOffset(R.dimen.dimen_24));
        ...
        lp = new LayoutParams(getResources().getDimensionPixelOffset(R.dimen.dimen_24), getResources().getDimensionPixelOffset(R.dimen.dimen_24));
        buttonSubtract.setBackground(getResources().getDrawable(R.drawable.btn_minus));
...
//        button.setText(label);
    ...
    private EditText buildEditText(Context context, AttributeSet attributeSet) {
        ...
        editText.setText(displayFractions(getRoundedValue()));
...
//        editText.setText(getRoundedValue());
        ...
        editText.setText(displayFractions(String.valueOf(value)));
    ...
    private String displayFractions(String value) {
        try {
            String[] frequencies = value.split("\\.");

            if (frequencies[1].equals("25")) {
                frequencies[1] = "\u00BC";
                if (frequencies[0].equals("0"))
                    value = frequencies[1];
                else
                    value = frequencies[0] + frequencies[1];
            } else if (frequencies[1].equals("75")) {
                frequencies[1] = "\u00BE";
                if (frequencies[0].equals("0"))
                    value = frequencies[1];
                else
                    value = frequencies[0] + frequencies[1];
            } else if (frequencies[1].equals("5")) {
                frequencies[1] = "\u00BD";
                if (frequencies[0].equals("0"))
                    value = frequencies[1];
                else
                    value = frequencies[0] + frequencies[1];
            } else if (frequencies[1].equals("0")) {
                if (frequencies[0].equals("0"))
                    value = "0";
                else
                    value = frequencies[0];
    ...
    public void setAddButtonBackground(Drawable drawable) {
        buttonAdd.setBackground(drawable);
    }

    public void setSubtractButtonBackground(Drawable drawable) {
        buttonSubtract.setBackground(drawable);
    }
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        String newValue = Utils.displayFractionstoDecimals(s.toString());
        if(!newValue.trim().isEmpty()){
            float previous = value;
            value = Float.parseFloat(newValue.trim());
            if (value != previous) {
                updateAndAlertListener();
            }
        }
